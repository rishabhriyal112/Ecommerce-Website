...
const SaleProducts = () => {
  ...
  // Filter products with a discount as "on sale"
    ...
    <div className="bg-white py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Sale Products</h1>
        ...
        {saleProducts.length > 0 ? (
          ...
          <div className="text-center py-12">
            <p className="text-gray-500 text-lg">No sale products available at the moment.</p>
